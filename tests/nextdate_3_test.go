...
func TestNextDate(t *testing.T) {
	...
	tbl = []nextDate{
		...
		{"20240329", "m 10,17 12,8,1", "20240810"}, // 10 августа - ближайшая дата  к заданной date
		{"20230311", "m 07,19 05,6", "20240507"},   // после того, как нам пришла дата, делаем её больше now
		{"20230311", "m 1 1,2", "20240201"},        // этой дате плюсуем значения, пока не станем равными переданной дате.
		{"20240127", "m -1", "20240131"},           // после этого приплюсовываемся до ближайшего месяца
